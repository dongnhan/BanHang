...
Partial Public Class XtraReport_CongNoPhaiThu
    ...
    Private Sub InitializeComponent()
        ...
        Me.Title.Text = "BẢNG CÔNG NỢ PHẢI THU"
        ...
        '
        Me.LightSwitchDataSource1.CollectionName = "vTồn_Công_Nợ_Phải_Thu_Khách_Hàng"
        Me.LightSwitchDataSource1.DataSource = GetType(LightSwitchApplication.vTồn_Công_Nợ_Phải_Thu_Khách_HàngItem)
        Me.LightSwitchDataSource1.DataSourceName = "BanHangData1"
        '
        'XtraReport_CongNoPhaiThu
        '
