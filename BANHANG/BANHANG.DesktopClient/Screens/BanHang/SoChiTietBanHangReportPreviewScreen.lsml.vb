...
Namespace LightSwitchApplication
    ...
    Public Class SoChiTietBanHangReportPreviewScreen
        ...
        Private Sub SoChiTietBanHangReportPreviewScreen_Activated()
            ' Assign the name of the report, which you want to preview in this screen.
            Me.ReportTypeName = "XtraReport_SoChiTietBanHang"
        End Sub
