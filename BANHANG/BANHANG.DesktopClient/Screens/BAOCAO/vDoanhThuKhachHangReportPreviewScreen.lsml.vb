...
Namespace LightSwitchApplication
    ...
    Public Class vDoanhThuKhachHangReportPreviewScreen
        ...
        Public Sub CustomizeReportPreviewModel(model As DevExpress.Xpf.Printing.ReportPreviewModel)
            ...
            model.Parameters("KhachHang").Value = Me.IdKhachHang
            model.Parameters("TenKhachHang").Value = Me.TenKhachHang
            model.CreateDocument()
        End Sub

        Private Sub vDoanhThuKhachHangReportPreviewScreen_Activated()
            ' Assign the name of the report, which you want to preview in this screen.
            Me.ReportTypeName = "XtraReport_DoanhThuKhachHang"
        End Sub
