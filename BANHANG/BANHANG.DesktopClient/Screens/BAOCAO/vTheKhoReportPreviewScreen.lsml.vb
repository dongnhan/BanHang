...
Namespace LightSwitchApplication
    ...
    Public Class vTheKhoReportPreviewScreen
        ...
        Public Sub CustomizeReportPreviewModel(model As DevExpress.Xpf.Printing.ReportPreviewModel)
            ...
            model.Parameters("IdSanPham").Value = Me.IdSanPham
            model.CreateDocument()
        End Sub

        Private Sub vTheKhoReportPreviewScreen_Activated()
            ' Assign the name of the report, which you want to preview in this screen.
            Me.ReportTypeName = "XtraReport_TheKhoTongHop"
        End Sub
