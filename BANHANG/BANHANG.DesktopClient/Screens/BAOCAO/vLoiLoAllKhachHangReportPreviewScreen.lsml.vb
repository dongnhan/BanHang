...
Namespace LightSwitchApplication
    ...
    Public Class vLoiLoAllKhachHangReportPreviewScreen
        ...
        Private Sub vLoiLoAllKhachHangReportPreviewScreen_Activated()
            ' Assign the name of the report, which you want to preview in this screen.
            Me.ReportTypeName = "XtraReport_LoiLoAllKhachHang"
        End Sub
