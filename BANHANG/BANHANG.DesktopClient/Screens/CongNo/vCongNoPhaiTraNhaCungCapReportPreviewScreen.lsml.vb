...
Namespace LightSwitchApplication
    ...
    Public Class vCongNoPhaiTraNhaCungCapReportPreviewScreen
        ...
        Private Sub vCongNoPhaiTraNhaCungCapReportPreviewScreen_Activated()
            ' Assign the name of the report, which you want to preview in this screen.
            Me.ReportTypeName = "XtraReport_CongNoPhaiTra"
        End Sub
