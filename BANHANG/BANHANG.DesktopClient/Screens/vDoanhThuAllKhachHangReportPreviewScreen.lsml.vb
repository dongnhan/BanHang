...
Namespace LightSwitchApplication
    ...
    Public Class vDoanhThuAllKhachHangReportPreviewScreen
        ...
        Private Sub vDoanhThuAllKhachHangReportPreviewScreen_Activated()
            ' Assign the name of the report, which you want to preview in this screen.
            Me.ReportTypeName = "XtraReport_DoanhThuAllKhachHang"
        End Sub
